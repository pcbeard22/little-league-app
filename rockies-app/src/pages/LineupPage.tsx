...
function SortablePlayerRow({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`grid grid-cols-[auto_auto_auto_1fr_repeat(6,34px)] sm:grid-cols-[auto_auto_auto_1fr_repeat(6,40px)] lg:grid-cols-[auto_auto_auto_1fr_repeat(6,48px)] items-center gap-0 border-b border-surface-container-highest ${
        isDragging
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-[55%]">
            <div className="bg-white rounded-2xl shadow-sm border border-surface-container-highest overflow-hidden">
              {/* Header row */}
              <div className="grid grid-cols-[auto_auto_auto_1fr_repeat(6,34px)] sm:grid-cols-[auto_auto_auto_1fr_repeat(6,40px)] lg:grid-cols-[auto_auto_auto_1fr_repeat(6,48px)] items-center gap-0 bg-surface-container-low border-b border-surface-container-highest">
                <div className="w-8" />
